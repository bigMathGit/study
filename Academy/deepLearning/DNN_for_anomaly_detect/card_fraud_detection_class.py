...
# DNN Class
dnn = DNN.DNN(input_nodes, 2, loss='cross', opt='adam')
accuracy_summary, cost_summary, valid_accuracy_summary, valid_cost_summary = dnn.run(inputX, inputY, inputX_valid, inputY_valid, epochs=5, batch_size=2048, display_step=1, n_samples=y_train.shape[0])
dnn.do_test(inputX_test, inputY_test)
